 ...
 */
inline void usart_driver_start(void) {
...
/**
 * @brief Serial driver specific initialization function for the master side.
 */
...
/**
 * @brief Serial driver specific initialization function for the slave side.
 */
