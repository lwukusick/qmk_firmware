...
void bootloader_jump(void) { reset_usb_boot(RP2040_BOOTLOADER_DOUBLE_TAP_RESET_LED_MASK, 0U); }
...
static uint32_t __attribute__((section(".ram0.bootloader_magic"))) magic_location;
